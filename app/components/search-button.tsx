      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Suggestions">
            <CommandItem
              onSelect={() => {
                runCommand(() => console.log("Calendar"))
              }}
            >
            ...
            <CommandItem
              onSelect={() => {
                runCommand(() => console.log("Search Emoji"))
              }}
            >
            ...
            <CommandItem
              onSelect={() => {
                runCommand(() => console.log("Calculator"))
              }}
            >
          ...
          <CommandGroup heading="Settings">
            <CommandItem
              onSelect={() => {
                runCommand(() => console.log("Profile"))
              }}
            >
...
function FaceIcon(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
function CalculatorIcon(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
